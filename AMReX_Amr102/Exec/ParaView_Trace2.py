...
plt00050 = AMReXBoxLibGridReader(registrationName='plt00050', FileNames=['/home/erik/Work/ATPESC-codes/AMReX_Amr102/Exec/plt00050'])
...
plt00050_1 = AMReXBoxLibParticlesReader(registrationName='plt00050', FileNames=['/home/erik/Work/ATPESC-codes/AMReX_Amr102/Exec/plt00050'])
...
glyph1Display.ScaleFactor = 0.054990595579147344
glyph1Display.SelectScaleArray = 'None'
glyph1Display.GlyphType = 'Arrow'
glyph1Display.GlyphTableIndexArray = 'None'
glyph1Display.GaussianRadius = 0.002749529778957367
...
# Properties modified on glyph1
glyph1.ScaleFactor = 0.011598429799809294

# update the view to ensure updated data information
renderView1.Update()

# Properties modified on glyph1
glyph1.ScaleFactor = 0.006555634234674818

# update the view to ensure updated data information
renderView1.Update()

# Properties modified on glyph1
glyph1.ScaleFactor = 0.007059913791188266

# update the view to ensure updated data information
renderView1.Update()

# Properties modified on glyph1
glyph1.ScaleFactor = 0.00605135467816137
...
ebpvtp = XMLPartitionedPolydataReader(registrationName='eb.pvtp', FileName=['/home/erik/Work/ATPESC-codes/AMReX_Amr102/Exec/eb.pvtp'])
...
phiLUTColorBar.Position = [0.8710526315789473, 0.05598114319387153]
phiLUTColorBar.ScalarBarLength = 0.3299999999999999
...
layout1.SetSize(1827, 1642)

#-----------------------------------
# saving camera placements for views

# current camera placement for renderView1
renderView1.CameraPosition = [1.028198570658624, 0.4584668271841574, 2.753539980103587]
renderView1.CameraFocalPoint = [0.4999999999999988, 0.4999999999999988, 0.062499999999999806]
renderView1.CameraViewUp = [-0.010553370241915723, 0.9997911301298625, 0.017502071025725572]
...
SaveScreenshot('/home/erik/Work/ATPESC-codes/AMReX_Amr102/Exec/image50_script.png', renderView1, ImageResolution=[1827, 1642])
